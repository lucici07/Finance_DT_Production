...
const files=['index.html','app.js','sync.js','bootstrap.js','shared-workspace.js','sync.css','share.html','share.js','styles.css','details.css','calendar.css','dashboard.css','production.css','vendor/exceljs.min.js'];
