...
const files=['index.html','app.js','entry.js','library.js','export.js','export.css','mobile.js','mobile.css','bootstrap.js','shared-workspace.js','sync.css','share.html','share.js','styles.css','details.css','calendar.css','dashboard.css','production.css','vendor/exceljs.min.js'];
