...
const files=['index.html','app.js','sync.js','export.js','export.css','mobile.js','mobile.css','bootstrap.js','shared-workspace.js','share.html','share.js','styles.css','details.css','calendar.css','dashboard.css','production.css','sync.css','vendor/exceljs.min.js'];
